...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishika\\OneDrive\\Desktop\\college\\Lab in psychology\\INTENTIONAL BINDING\\Intentional binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    display_text = visual.TextStim(win=win, name='display_text',
        text='Report the delay between they key press and beep sound (0-999) in ms \nClick submit after entering the value.\n',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        button.reset()
        # keep track of which components have finished
        responsesComponents = [display_text, textbox, button]
