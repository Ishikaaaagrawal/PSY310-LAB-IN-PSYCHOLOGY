...
expName = 'lexical decision'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishika\\OneDrive\\Desktop\\college\\Lab in psychology\\Solo project\\lexical decision_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome! You will see words or non-words on the screen. Press 'W' if it's a word, and 'N' if it's not a word. Try to respond as quickly and accurately as possible. Press any key to begin.",
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        trialComponents = [fixation, stimuli, key_resp_2]
        ...
        while continueRoutine:
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_2.getKeys(keyList=['w','n'], ignoreKeys=["escape"], waitRelease=False)
