...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishika\\OneDrive\\Desktop\\college\\Lab in psychology\\5 word primining\\word priming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/Ishika/OneDrive/Desktop/college/Lab in psychology/5 word primining/study_word.xlsx'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/Ishika/OneDrive/Desktop/college/Lab in psychology/5 word primining/test.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        testComponents = [TestText, textbox, submit_text, testmouse]
