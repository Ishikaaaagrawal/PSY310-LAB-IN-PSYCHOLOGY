...
expName = 'visula search'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishika\\OneDrive\\Desktop\\college\\Lab in psychology\\5 VISUAL SEARCH\\visual search_lastrun.py',
